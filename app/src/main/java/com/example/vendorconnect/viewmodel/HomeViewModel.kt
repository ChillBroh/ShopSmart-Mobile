package com.example.vendorconnect.viewmodel
...
import com.example.vendorconnect.data.Image
import com.example.vendorconnect.data.ImageDatabase
import com.example.vendorconnect.data.ProductDatabase
import com.example.vendorconnect.model.BaseClass
import com.example.vendorconnect.model.Product
import com.example.vendorconnect.service.ProductsAPI
import com.example.vendorconnect.util.CustomSharedPreferences
import com.example.vendorconnect.view.MainActivity
...
class HomeViewModel : ViewModel() {
    ...
    fun storeInSQLite(context: Context, products: ArrayList<Product>) {
        ...
        viewModelScope.launch {
            ...
            products.forEach {
                val aProduct = com.example.vendorconnect.data.Product(it.id,it.title,it.description,it.price,it.discountPercentage,it.rating,it.stock,it.brand,it.category,
                    it.thumbnail)
