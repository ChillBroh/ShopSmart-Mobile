...
import com.example.vendorconnect.adapter.CartAdapter
...
import com.example.vendorconnect.databinding.FragmentCartBinding
...
class CartViewModel() : ViewModel() {
    ...
    fun updateQuantity(increaseQuantity : Boolean, id: Int, database: CartDatabase, holder: CartAdapter.PlaceHolder) = viewModelScope.launch(
        Dispatchers.IO) {
